(ns marketentry.store
  "SSoT for the MCO market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems MC" :portal "RCI"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-administrative-authorization? false :has-administrative-authorization? false
             :has-declaration-receipt? true
             :requires-fiscal-declaration? true :fiscal-declaration-verified? true
             :drafted? false :submitted? false
             :jurisdiction "MCO" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "RCI"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-administrative-authorization? false :has-administrative-authorization? false
             :has-declaration-receipt? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "RCI"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "MCO" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Conseil" :portal "RCI"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-administrative-authorization? true :has-administrative-authorization? false
             :has-declaration-receipt? true
             :requires-fiscal-declaration? true :fiscal-declaration-verified? true
             :drafted? false :submitted? false
             :jurisdiction "MCO" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "RCI"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-administrative-authorization? false :has-administrative-authorization? false
             :has-declaration-receipt? true
             :requires-fiscal-declaration? true :fiscal-declaration-verified? false
             :drafted? false :submitted? false
             :jurisdiction "MCO" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "RCI"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-administrative-authorization? has-administrative-authorization?
                               has-declaration-receipt?
                               requires-fiscal-declaration? fiscal-declaration-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-administrative-authorization?) (assoc :engagement/requires-administrative-authorization? requires-administrative-authorization?)
    (some? has-administrative-authorization?)      (assoc :engagement/has-administrative-authorization? has-administrative-authorization?)
    (some? has-declaration-receipt?)                (assoc :engagement/has-declaration-receipt? has-declaration-receipt?)
    (some? requires-fiscal-declaration?)            (assoc :engagement/requires-fiscal-declaration? requires-fiscal-declaration?)
    (some? fiscal-declaration-verified?)            (assoc :engagement/fiscal-declaration-verified? fiscal-declaration-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-administrative-authorization? :engagement/has-administrative-authorization?
   :engagement/has-declaration-receipt?
   :engagement/requires-fiscal-declaration? :engagement/fiscal-declaration-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-administrative-authorization? (boolean (:engagement/requires-administrative-authorization? m))
     :has-administrative-authorization? (boolean (:engagement/has-administrative-authorization? m))
     :has-declaration-receipt? (boolean (:engagement/has-declaration-receipt? m))
     :requires-fiscal-declaration? (boolean (:engagement/requires-fiscal-declaration? m))
     :fiscal-declaration-verified? (boolean (:engagement/fiscal-declaration-verified? m))
